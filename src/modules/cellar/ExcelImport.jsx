      ...
      <div className="fixed inset-x-0 bottom-0 top-10 z-[60] bg-white dark:bg-gray-800 rounded-t-3xl shadow-2xl flex flex-col">
          ...
          {step === 'pick' && (
            <div className="space-y-3 text-center py-10">
              ...
              <label className="inline-block">
                <span className="bg-rose-600 hover:bg-rose-700 text-white text-sm font-semibold px-4 py-2.5 rounded-xl cursor-pointer inline-block">
                  Datei auswählen
                </span>
                  ...
                  {racks.map(r => (
                    <button key={r.id} onClick={() => setTargetRackId(r.id)}
                      className={`px-2.5 py-1 rounded-full text-xs font-semibold ${
                        targetRackId === r.id ? 'bg-rose-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300'
        ...
        {step !== 'pick' && (
          <div className="border-t px-5 py-3 flex gap-2">
            ...
            <button onClick={doImport} className="btn-primary flex-1" style={{ backgroundColor: '#e11d48' }}>
